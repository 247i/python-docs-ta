Translation of the Python Documentation — ta
============================================

.. image:: https://travis-ci.org/python/python-docs-ta.svg?branch=3.11
  :target: https://travis-ci.org/python/python-docs-ta
...
- Or just by opening `an issue on github <https://github.com/python/python-docs-ta/issues>`_
...
You'll need to fork the `python-docs-ta
<https://github.com/python/python-docs-ta>`_ clicking its ``Fork``
...
.. code-block:: bash
    ...
    git clone git@github.com:JulienPalard/python-docs-ta.git

    # Go to the cloned directory:
    cd python-docs-ta/

    # Add the upstream (the public repository) using HTTPS (won't ask for password):
    git remote add upstream https://github.com/python/python-docs-ta.git
...
.. code-block:: bash
    ...
    # https://github.com/python/python-docs-ta/ and a nice "Compare & pull request"
...
All those snippets are to run from the root of a ``python-docs-ta``
